                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="nama_ayah" name="nama_ayah" class="form-control"
                                            value="{{ old('nama_ayah', $siswa->wali->nama_ayah ?? '') }}">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="pekerjaan_ayah">Pekerjaan Ayah:</label>
                                        <input type="text" id="pekerjaan_ayah" name="pekerjaan_ayah" class="form-control"
                                            value="{{ old('pekerjaan_ayah', $siswa->wali->pekerjaan_ayah ?? '') }}">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="no_hp_ayah">No HP Ayah:</label>
                                        <input type="text" id="no_hp_ayah" name="no_hp_ayah" class="form-control"
                                            value="{{ old('no_hp_ayah', $siswa->wali->no_hp_ayah ?? '') }}">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="alamat_ayah">Alamat Ayah:</label>
                                        <input type="text" id="alamat_ayah" name="alamat_ayah" class="form-control"
                                            placeholder="Alamat Ayah"
                                            value="{{ old('alamat_ayah', $siswa->wali->alamat_ayah) }}">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="nama_ibu" name="nama_ibu" class="form-control"
                                            value="{{ old('nama_ibu', $siswa->wali->nama_ibu ?? '') }}">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="pekerjaan_ibu">Pekerjaan Ibu:</label>
                                        <input type="text" id="pekerjaan_ibu" name="pekerjaan_ibu" class="form-control"
                                            value="{{ old('pekerjaan_ibu', $siswa->wali->pekerjaan_ibu ?? '') }}">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="no_hp_ibu">No HP Ibu:</label>
                                        <input type="text" id="no_hp_ibu" name="no_hp_ibu" class="form-control"
                                            value="{{ old('no_hp_ibu', $siswa->wali->no_hp_ibu ?? '') }}">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="alamat_ibu">Alamat Ibu:</label>
                                        <input type="text" id="alamat_ibu" name="alamat_ibu" class="form-control"
                                            placeholder="Alamat ibu"
                                            value="{{ old('alamat_ibu', $siswa->wali->alamat_ayah) }}">
                                    </div>
                                </div>
                            </div>
