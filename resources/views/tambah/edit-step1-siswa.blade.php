                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" id="tb" name="tb" class="form-control"
                                                value="{{ old('tb', $siswa->kesehatan->tb ?? '') }}">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" id="thn_msk" name="thn_msk" class="form-control"
                                                value="{{ old('thn_msk', $siswa->thn_msk) }}">
                                        </div>
                                    </div>
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="number" id="bb" name="bb" class="form-control"
                                                value="{{ old('bb', $siswa->kesehatan->bb ?? '') }}">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group mb-3">
                                        ...
                                        <textarea id="alamat" name="alamat" class="form-control" rows="2" placeholder="masukan alamat tinggal">{{ old('alamat', $siswa->alamat ?? '') }}</textarea>
                                    </div>
                                </div>
                            </div>
