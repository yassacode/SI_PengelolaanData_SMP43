...
@section('title','Tambah Data Disiplin')
@section('add')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select name="siswa_id" id="siswa_id" class="form-select @error('siswa_id') is-invalid @enderror">
                                        ...
                                        @foreach ($siswa as $student)
                                            <option value="{{ $student->id }}" {{ old('siswa_id') == $student->id ? 'selected' : '' }}>{{ $student->nama }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" id="masalah" name="masalah" class="form-control @error('masalah') is-invalid @enderror" placeholder="Contoh: Bolos, Terlambat" value="{{ old('masalah') }}">
